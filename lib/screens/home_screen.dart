                ...
                if (isSearching != true)
                  Container(
                    ...
                    child: IconButton(
                      ...
                      icon: Icon(
                        Icons.filter_alt,
                        color: seeFilters ? Colors.blue.shade500 : Colors.black87,
                      ),
                    ),
                  ),
              ],
              ...
              child: ListView(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text('Surname1', style: TextStyle(color: Colors.white),),
                    style: ButtonStyle(
                  ...
                  ElevatedButton(
                    ...
                    child: Text('Surname2', style: TextStyle(color: Colors.white),),
                    style: ButtonStyle(
                  ...
                  ElevatedButton(
                    ...
                    child: Text('birth date', style: TextStyle(color: Colors.white),),
                    style: ButtonStyle(
